...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'peg_hole_policy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'guillaume <guillaume@todo.todo>' to fix it.")
    endif()
...
set(peg_hole_policy_EXPORTED_TARGETS "peg_hole_policy_generate_messages_cpp;peg_hole_policy_generate_messages_lisp;peg_hole_policy_generate_messages_py;peg_hole_policy_gencfg")

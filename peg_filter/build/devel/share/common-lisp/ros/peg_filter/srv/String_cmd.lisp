...
(cl:defmethod cl:initialize-instance :after ((m <String_cmd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'String_cmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name peg_filter-srv:<String_cmd-request> is deprecated: use peg_filter-srv:String_cmd-request instead.")))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <String_cmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader peg_filter-srv:cmd-val is deprecated.  Use peg_filter-srv:cmd instead.")
  (cmd m))
...
(cl:defmethod cl:initialize-instance :after ((m <String_cmd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'String_cmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name peg_filter-srv:<String_cmd-response> is deprecated: use peg_filter-srv:String_cmd-response instead.")))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <String_cmd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader peg_filter-srv:res-val is deprecated.  Use peg_filter-srv:res instead.")
  (res m))

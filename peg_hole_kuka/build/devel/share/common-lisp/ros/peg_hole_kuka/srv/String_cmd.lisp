...
(cl:in-package peg_hole_kuka-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <String_cmd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'String_cmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name peg_hole_kuka-srv:<String_cmd-request> is deprecated: use peg_hole_kuka-srv:String_cmd-request instead.")))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <String_cmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader peg_hole_kuka-srv:cmd-val is deprecated.  Use peg_hole_kuka-srv:cmd instead.")
  (cmd m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<String_cmd-request>)))
  ...
  "peg_hole_kuka/String_cmdRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'String_cmd-request)))
  "Returns string type for a service object of type 'String_cmd-request"
  "peg_hole_kuka/String_cmdRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <String_cmd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'String_cmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name peg_hole_kuka-srv:<String_cmd-response> is deprecated: use peg_hole_kuka-srv:String_cmd-response instead.")))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <String_cmd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader peg_hole_kuka-srv:res-val is deprecated.  Use peg_hole_kuka-srv:res instead.")
  (res m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<String_cmd-response>)))
  ...
  "peg_hole_kuka/String_cmdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'String_cmd-response)))
  "Returns string type for a service object of type 'String_cmd-response"
  "peg_hole_kuka/String_cmdResponse")
